...
export default function Skills() {
  ...
  const showBento = false;

  return (
    <section id="skills" className="relative bg-background">
      <div className="text-foreground relative w-full pt-32 pb-32 px-6">
        <div className="max-w-container mx-auto">
          {/* SectionHeader e BentoGrid ocultos — mude showBento para true para reativar */}
          {showBento && (
            <>
